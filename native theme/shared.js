...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const revealSelectors = [
    ...
    ".reveal-rotate", ".reveal-blur", ".reveal-flip", ".timeline-line",
  ...
  if (window.innerWidth > 768 && !isTouchDevice) {
    ...
    const hoverTargets = "a, button, .card-interaction, .btn-hover, .faq-item, .tilt-card, input, textarea, select";
  ...
  if (particleCanvas) {
    ...
    const particleCount = isMobile ? 20 : Math.min(60, Math.floor(window.innerWidth / 25));
  ...
  // ============================================
  document.querySelectorAll(".icon-hover-bounce, .icon-hover-spin").forEach((el) => {
