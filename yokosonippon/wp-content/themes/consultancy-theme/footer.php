        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div class="lg:col-span-4 flex flex-col gap-4 lg:pt-16 lg:items-end text-left lg:text-right reveal-right stagger-3">
                ...
                <nav class="flex flex-col gap-3" aria-label="Footer navigation">
                    <a class="font-body-md text-body-md text-on-surface-variant hover:text-primary transition-all duration-300 opacity-80 hover:opacity-100" href="<?php echo esc_url(home_url('/home')); ?>">Home</a>
                    <a class="font-body-md text-body-md text-on-surface-variant hover:text-primary transition-all duration-300 opacity-80 hover:opacity-100" href="<?php echo esc_url(home_url('/study-hub')); ?>">Study Hub</a>
                    <a class="font-body-md text-body-md text-on-surface-variant hover:text-primary transition-all duration-300 opacity-80 hover:opacity-100" href="<?php echo esc_url(home_url('/services')); ?>">Services</a>
                    <a class="font-body-md text-body-md text-on-surface-variant hover:text-primary transition-all duration-300 opacity-80 hover:opacity-100" href="<?php echo esc_url(home_url('/about-us')); ?>">About Us</a>
                    <a class="font-body-md text-body-md text-on-surface-variant hover:text-primary transition-all duration-300 opacity-80 hover:opacity-100" href="<?php echo esc_url(home_url('/contact')); ?>">Contact & FAQ</a>
                </nav>
            </div>
        </div>
        <!-- Copyright -->
